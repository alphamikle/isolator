...
typedef BackendAction<Event, Req, Res> = FutureOr<ActionResponse<Res>> Function(
    {required Event event, required Req data});
typedef BackendActionShort<Res> = FutureOr<ActionResponse<Res>> Function(
    {dynamic event, dynamic data});
